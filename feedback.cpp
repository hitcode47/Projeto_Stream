...
void Feed::Fazer_comentario(std::string Artista, std::string Musica, std::string Usuario){
    ...
    arquivo << Artista << " - " << Musica << " , " << Usuario << ":" << comentario << std::endl; // Adiciona o comentário à mesma linha
    arquivo.close();
...
void Feed::Ler_Comentario(std::string Artista, std::string Musica, std::string Usuario) {
